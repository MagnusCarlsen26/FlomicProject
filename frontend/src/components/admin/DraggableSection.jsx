  ...
  return (
    ...
    >
      <div className="absolute right-3 top-3 z-10 flex items-center gap-2">
        {onToggleCollapsed ? (
          <button
            ...
            className="inline-flex h-8 w-8 items-center justify-center rounded-full border border-border-strong bg-surface-muted text-text-secondary transition hover:bg-surface hover:text-text-primary focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary/70"
      ...
      {!isCollapsed ? (
        ...
        <div className="rounded-3xl border border-border bg-surface/70 px-4 py-4 pr-36">
          <p className="text-sm font-semibold uppercase tracking-wide text-text-muted">{collapsedLabel || id}</p>
        </div>
      )}
    </div>
  )
